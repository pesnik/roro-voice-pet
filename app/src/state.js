...
// Claude Code transcript-tail reading lived in hooks/clawd-hook.js, which
// only exists alongside the Claude Code hook script itself. This app has no
// hook scripts, so there's no transcript file to read; the completion probe
// below (gated on a transcript_path our sidecar never sends) degrades to a
// harmless no-op rather than promoting a completion early.
function readClaudeTranscriptTailEntries() { return []; }
function extractLastClaudeAssistantTextFromEntries() { return null; }
