...
contextBridge.exposeInMainWorld("minicpmSettings", {
  ...
  getBackendMode: () => ipcRenderer.invoke("minicpm-settings:get-backend-mode"),
  setBackendMode: (mode) => ipcRenderer.invoke("minicpm-settings:set-backend-mode", { mode }),
  getSttBackend: () => ipcRenderer.invoke("minicpm-settings:get-stt-backend"),
  setSttBackend: (mode) => ipcRenderer.invoke("minicpm-settings:set-stt-backend", { mode }),
  getTtsBackend: () => ipcRenderer.invoke("minicpm-settings:get-tts-backend"),
  setTtsBackend: (mode) => ipcRenderer.invoke("minicpm-settings:set-tts-backend", { mode }),
