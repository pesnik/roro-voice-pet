...
(function initMinicpmI18n(root) {
  ...
  function getClassifierPrompt(lang) {
    return pickDict(CLASSIFIER_PROMPTS, lang).prompt || CLASSIFIER_PROMPTS.en.prompt;
  }
  ...
  const EN_STRINGS = {
    ...
    callButtonTitle: "Start Call",
    callEndButtonTitle: "End Call",
    callMuteButtonTitle: "Mute",
    callUnmuteButtonTitle: "Unmute",
    callConnecting: "Connecting…",
    callDownloadingModels: "Downloading voice models (first call only)…",
    callListening: "Listening…",
    callSpeaking: "Speaking…",
    callMuted: "Muted",
    callError: "Call error: {error}",
    callMicDenied: "Microphone access denied — enable it in System Settings → Privacy & Security → Microphone.",
  ...
  const ZH_STRINGS = {
    ...
    callButtonTitle: "开始通话",
    callEndButtonTitle: "结束通话",
    callMuteButtonTitle: "静音",
    callUnmuteButtonTitle: "取消静音",
    callConnecting: "连接中…",
    callDownloadingModels: "正在下载语音模型（仅首次通话）…",
    callListening: "正在聆听…",
    callSpeaking: "正在说话…",
    callMuted: "已静音",
    callError: "通话出错：{error}",
    callMicDenied: "麦克风访问被拒绝 — 请在「系统设置 → 隐私与安全性 → 麦克风」中开启。",
  ...
  const ZH_TW_STRINGS = {
    ...
    callButtonTitle: "開始通話",
    callEndButtonTitle: "結束通話",
    callMuteButtonTitle: "靜音",
    callUnmuteButtonTitle: "取消靜音",
    callConnecting: "連接中…",
    callDownloadingModels: "正在下載語音模型（僅首次通話）…",
    callListening: "正在聆聽…",
    callSpeaking: "正在說話…",
    callMuted: "已靜音",
    callError: "通話出錯：{error}",
    callMicDenied: "麥克風存取遭拒 — 請在「系統設定 → 隱私權與安全性 → 麥克風」中開啟。",
  ...
  const KO_STRINGS = {
    ...
    callButtonTitle: "통화 시작",
    callEndButtonTitle: "통화 종료",
    callMuteButtonTitle: "음소거",
    callUnmuteButtonTitle: "음소거 해제",
    callConnecting: "연결 중…",
    callDownloadingModels: "음성 모델 다운로드 중 (최초 통화 시에만)…",
    callListening: "듣는 중…",
    callSpeaking: "말하는 중…",
    callMuted: "음소거됨",
    callError: "통화 오류: {error}",
    callMicDenied: "마이크 접근이 거부되었습니다 — 시스템 설정 → 개인정보 보호 및 보안 → 마이크에서 활성화하세요.",
  ...
  const JA_STRINGS = {
    ...
    callButtonTitle: "通話を開始",
    callEndButtonTitle: "通話を終了",
    callMuteButtonTitle: "ミュート",
    callUnmuteButtonTitle: "ミュート解除",
    callConnecting: "接続中…",
    callDownloadingModels: "音声モデルをダウンロード中（初回通話のみ）…",
    callListening: "聞いています…",
    callSpeaking: "話しています…",
    callMuted: "ミュート中",
    callError: "通話エラー: {error}",
    callMicDenied: "マイクへのアクセスが拒否されました — システム設定 → プライバシーとセキュリティ → マイクで有効にしてください。",
